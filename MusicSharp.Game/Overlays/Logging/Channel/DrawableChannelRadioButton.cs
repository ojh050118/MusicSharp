...
{
    public class DrawableChannelRadioButton : DiscordButton
    {
        public Action<ChannelRadioButton> Selected;

        public readonly ChannelRadioButton Button;
        ...
        public DrawableChannelRadioButton(ChannelRadioButton button)
        {
            Button = button;
